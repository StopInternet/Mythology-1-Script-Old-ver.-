...
recipes.addShaped(<minecraft:structure_block>, [[<extrautils2:creativechest>], [<projectex:final_star>], [<extrautils2:creativechest>]]);
...
recipes.addShaped(<extrautils2:machine>.withTag({Type: "extrautils2:generator_ender"}), [[<circuit_resarch:soggyenderpearl>, <ore:enchanted_enderPearl>, <circuit_resarch:soggyenderpearl>], [<ore:quartzLavender>, <extrautils2:machine>, <ore:quartzLavender>], [<circuit_resarch:soggyenderpearl>, <ic2:advanced_heat_vent>, <circuit_resarch:soggyenderpearl>]]);
